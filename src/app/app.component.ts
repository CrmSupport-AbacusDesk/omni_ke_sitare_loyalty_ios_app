...
import { Platform, Nav, Events, App, ToastController, AlertController, NavController, LoadingController, Loading } from 'ionic-angular';
            ...
            if(val == '' || val == null || val == undefined)
            {
                ...
                .subscribe((r)=>
                {
                    ...
                    if(r['status'] == "SUCCESS"){
                        ...
                        this.karigar_id = r['karigar'].id;
                        this.point_image(this.karigar_id)
